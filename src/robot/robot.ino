...
void setup() {
  ...
  // motorTester();
  // gy25.update();
  // gyro_save_angle = gy25.absolute_x;
}
...
void flySkyMain() {
  ...
  // if (x==0 && y==0) gyro_save_angle = gy25.absolute_x;
  //if (rotation==0 && (x!=0 || y!=0)) rotation -= (gyro_save_angle - gy25.absolute_x) * 1;
